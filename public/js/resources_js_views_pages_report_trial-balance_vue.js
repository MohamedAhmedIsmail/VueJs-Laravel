...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
            ...
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                return that.axios.get("report/get-trial-balance").then(function (response) {
                  ...
                  that.computeNewVoucherData(that.vouchers); // console.log(that.vouchers);

                  // console.log(that.vouchers);
                  that.form.date_start = that.vouchers[0][0].firstDayInMonth;
                  that.form.date_end = that.vouchers[0][0].lastDayInMonth; // console.log(that.form.date_start,that.form.date_end);
                });
    ...
    computeNewVoucherData: function computeNewVoucherData(vouchers) {
      var _this3 = this;

      return (0,C_wamp64_vuejs_laravel_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().mark(function _callee3() {
        var i, newVoucherObj, j, newAncestorObj, item;
            ...
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                for (i = 0; i < vouchers.length; i++) {
                  newVoucherObj = vouchers[i][0];

                  for (j = 0; j < newVoucherObj.ancestors.length; j++) {
                    newAncestorObj = newVoucherObj.ancestors[j];

                    if (_this3.vouchersTree[newAncestorObj.id] === undefined) {
                      _this3.vouchersTree[newAncestorObj.id] = [newVoucherObj];
                    } else {
                      _this3.vouchersTree[newAncestorObj.id].push(newVoucherObj);
                    }
                  }
                }
                ...
                for (item in _this3.vouchersTree) {
                  console.log(item);
                  console.log(_this3.vouchersTree[item]);
                }
    ...
    getData: function getData() {
      ...
      return (0,C_wamp64_vuejs_laravel_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().mark(function _callee4() {
                          ...
                          _c(
                            ...
                            [
                              _vm._l(_vm.vouchers, function(voucher, index) {
                                return [
                                  _vm._l(voucher, function(voucherArr) {
                                    return _c("tr", [
                                      _c(
                                        "td",
                                        [
