...
/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @babel/runtime/regenerator */ "./node_modules/@babel/runtime/regenerator/index.js");
/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _layout_mainLayout_vue__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../layout/mainLayout.vue */ "./resources/js/views/layout/mainLayout.vue");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    Layout: _layout_mainLayout_vue__WEBPACK_IMPORTED_MODULE_3__["default"],
    ...
    Vue: vue__WEBPACK_IMPORTED_MODULE_7__["default"]
  },
  data: function data() {
    return {
  ...
  methods: {
                ...
                _loop = function _loop(index) {
                  if (that.optionData[index].child == true) {
                    ...
                    that.axios.get("options-child/" + that.optionData[index].index + '/' + that.optionData[index].option_id).then(function (response) {
                      ...
                      vue__WEBPACK_IMPORTED_MODULE_7__["default"].set(that.optionsChildChild, index, response.data);
              ...
              case 0:
                ...
                _loop2 = function _loop2(index) {
                  ...
                  if (that.optionData[index].child == true) {
                    that.axios.get("options-child/" + that.optionData[index].index + '/' + that.optionData[index].option_id).then(function (response) {
                      // that.optionsChild[index] = response.data;
                      vue__WEBPACK_IMPORTED_MODULE_7__["default"].set(that.optionsChild, index, response.data);
                      that.pending = false;
                    });
                  }
                };
    ...
    onChange: function onChange(event) {
      ...
      return (0,C_xampp_htdocs_vuejs_laravel_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default().mark(function _callee3() {
        var that;
    ...
    getCategories: function getCategories() {
      ...
      return (0,C_xampp_htdocs_vuejs_laravel_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default().mark(function _callee4() {
        var that;
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default().wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                that = _this4;
                that.properties = [], that.optionData = {}, that.optionsChild = [], that.inputOther = [], that.inputOtherString = [], that.pending = true;
    ...
    create: function create() {
      ...
      return (0,C_xampp_htdocs_vuejs_laravel_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default().mark(function _callee5() {
        var that, index, item;
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                ...
                index = 0;
                console.log(_this5.optionData);

                for (item in _this5.optionData) {
                  _this5.form.options.push(_this5.optionData[item]);
                            ...
                            _c("div", { staticClass: "form-group" }, [
                              ...
                              _c(
                                "select",
                                {
                                  ...
                                  attrs: { autocomplete: "on", required: "" },
                                  on: {
                                    change: [
                                      function($event) {
                                        ...
                                        _vm.subCategories = $event.target
                                          .multiple
                                          ? $$selectedVal
                                          : $$selectedVal[0]
                                      },
                              ...
                              _c("div", { staticClass: "form-group" }, [
                                ...
                                _c(
                                  ...
                                  [
                                    ...
                                    _vm._v(" "),
                                    _vm._l(property.options, function(option) {
                                      return _c(
                                        "option",
                                        {
                                          key: option.id,
